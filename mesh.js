window.MeshVerify = {
    config: {
        ...
        iframeUrl: 'https://staging.one-click-verify.mesh.id', // change to production
    },
    ...
    buildModal: function () {
        ...
        modalHeader.id = 'mesh-modal-header';
    ...
    injectStyles: function () {
        ...
        sheet.innerHTML = `      
            #mesh-iframe { width: 100%; height: calc(100% - 31px); background-color: rgb(255 255 255); }
            ...
            #mesh-close-btn {  outline: none; border: none; box-shadow: none; background: none;}
            #mesh-modal-overlay { z-index: 2147483647; position: fixed; top: 0; right: 0; bottom: 0; left: 0;}
            #mesh-modal { background-color: white; overflow:hidden; box-shadow: 0 6px 7px rgb(0 0 0 / 30%); margin: auto; margin-top: 40px; width: 510px; height: 90%; max-width: 95%; position: relative; border-radius: 6px; }
            #mesh-modal-header { background-color: rgb(255 255 255); text-align: right; padding: 5px 5px 0 5px;  }
        `;
